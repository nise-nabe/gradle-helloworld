...
import oecd.ties.crsstf.v5.OECDLegalAddressTypeEnumType;
 ...
 *         &lt;choice&gt;
 *           &lt;element name="AddressFree" type="{urn:oecd:ties:crsstf:v5}StringMin1Max4000_Type"/&gt;
 *           &lt;sequence&gt;
 *             &lt;element name="AddressFix" type="{urn:oecd:ties:commontypesfatcacrs:v2}AddressFix_Type"/&gt;
 *             &lt;element name="AddressFree" type="{urn:oecd:ties:crsstf:v5}StringMin1Max4000_Type" minOccurs="0"/&gt;
 *           &lt;/sequence&gt;
 *         &lt;/choice&gt;
 *       &lt;/sequence&gt;
 *       &lt;attribute name="legalAddressType" type="{urn:oecd:ties:crsstf:v5}OECDLegalAddressType_EnumType" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
public class AddressType {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "CountryCode", namespace = "urn:oecd:ties:commontypesfatcacrs:v2", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "AddressFree", namespace = "urn:oecd:ties:commontypesfatcacrs:v2", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "AddressFix", namespace = "urn:oecd:ties:commontypesfatcacrs:v2", type = JAXBElement.class, required = false)
    })
     ...
     * line 89 of file:/mnt/k/Users/yuya%20WTNB/IdeaProjects/nise-nabe/gradle-helloworld/subprojects/hello-crs/src/main/resources/CRS-Schema-v2.0/CommonTypesFatcaCrs_v2.0.xsd
     * line 86 of file:/mnt/k/Users/yuya%20WTNB/IdeaProjects/nise-nabe/gradle-helloworld/subprojects/hello-crs/src/main/resources/CRS-Schema-v2.0/CommonTypesFatcaCrs_v2.0.xsd
     * <p>
